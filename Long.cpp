...
Long Long::gcd(const Long &l1, const Long &l2) {
    ...
    bool odd_step = false; // true - res1 > res2, false - res1 < res2
...
ElGamal::ElGamal() {
    ...
    _g = Long::primitive_root(_p); // primitive root of Zp
...
bool EC::ECPoint::operator==(const ECPoint &q) const {
    return (_inf && q._inf) || (_inf == q._inf && _x == q._x && _y == q._y);
}
